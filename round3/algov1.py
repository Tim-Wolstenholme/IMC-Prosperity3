...
class Trader:
    ...
    def alt_rock_voucher_order(self, rock_voucher_order_depth: OrderDepth,
        ...
        #Essentially trading when there is a difference between BS price and orderbook price
        fair_prices = {}
        ...
        for asset in assets:
            ...
            fair_prices[asset] = fair_price
        calls = {}
        deltas = {}
        for asset in assets:
            calls[asset] = BlackScholes.black_scholes_call(fair_prices[asset],int(asset[22:]), 7/252, volatility)
            deltas[asset] = BlackScholes.delta(fair_prices[asset],int(asset[22:]), 7/252, volatility)
        for asset in assets:
    ...
    def run(self, state: TradingState):
        ...
        # Round 3
        for VOUCHER in [Product.VOLCANIC_ROCK_VOUCHER_9500, Product.VOLCANIC_ROCK_VOUCHER_9750,
