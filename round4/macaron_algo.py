...
class Trader:
    ...
    def take_macaron(self, state, market_data):
        ...
        if current_sunlight < 50:
            ...
            # Go short if sunlight is increasing rapidly from below 50
                ...
                product] > 0 and self.calculate_sunlight_rate_of_change() > 0.008:
    ...
    def make_macaron(self, state, market_data):
        ...
        buy_cap = self.limits[product] - pos
        sell_cap = self.limits[product] + pos
    ...
    def run(self, state: TradingState):
        ...
        conversions = 0
        mac_take, conversions = self.take_macaron(state, market_data)
        ...
        traderData = jsonpickle.encode(traderObject)  # json.dumps(prices)
